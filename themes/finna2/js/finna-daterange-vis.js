...
finna.dateRangeVis = (function finnaDateRangeVis() {
  ...
  function plotData(delay) {
    ...
    // Bind events
    vis.off('plotclick').bind('plotclick', function onPlotClick(event, pos/*, item*/) {
      if (!visRangeSelected) {
    ...
    vis.off('plotselecting plotselected').bind('plotselecting plotselected', function onPlotSelect(event, ranges) {
